...
export default function ProjectSection() {
  return (
    <div className="bg-background w-full text-foreground flex flex-col align-center justify-center h-full">
      <ShadowText className={"text-foreground"} alt>Projects.</ShadowText>
